        ...
        sections: [
            {
                ...
                items: [
                    ...
                    '금속 단조에 투구·흉갑·각반·철갑화를 추가해 머리·몸·다리·발 방어구도 직접 제작할 수 있게 했습니다.',
                ],
            },
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    '낚시 경험치는 현재 레벨과 물고기 희귀도에 따라 증가하며 일반 등급은 동레벨 일반 사냥 보상의 평균 80%를 지급하도록 조정했습니다.',
                    '단조 경험치는 완성품 장비 레벨과 거친·양호·우수·명품 품질에 따라 증가하며 양호 품질은 장비 동레벨 일반 사냥 보상의 80%를 지급합니다.',
                ],
            },
            {
                ...
                items: [
                    ...
                    '감정 화면에서 같은 능력치의 단조 재료·성향·강화 보정이 여러 줄로 반복되던 문제를 고쳐 고정값과 비율을 한 줄로 합쳤습니다.',
                    '홍염산지 3으로 향하는 흑요 선반 우회로에도 다른 진입로와 동일한 Lv.36 제한을 적용했습니다.',
