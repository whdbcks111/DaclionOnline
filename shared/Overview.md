...
- 유리모래 사막의 `location:desert`, `shop:caravan`, `material:glass`, 서리잔향 설원·빙경궁의 `location:frozen`, `shop:frost`, `material:rime`, 역설기계고의 `location:clockwork`, `shop:clockwork`, `material:clockwork`, 공허왕관의 `location:voidcrown`, `shop:voidcrown`, `material:voidcrown`, 월식해구의 `location:eclipse-trench`, `shop:eclipse-trench`, `material:eclipse-trench` 분류를 같은 공용 태그 API에서 소유한다.
