...
- `tags.ts`: `namespace:path` 검증, 투사체/탄약/광맥/보물/도구/광물/스킬북, 슬라임·정령·야수·보스, 광산·늪·화산 지역과 불·물·얼음·자연·독·전기·돌·어둠·빛·언데드·신성·벌레·금속·땅 속성을 포함한 공용 태그 ID, raw Set을 숨기는 `TagCollection/TagReadable/TagQuery` API.
