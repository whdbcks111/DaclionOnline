...
- `types.ts`: 태그와 `monster | resource` 통합 오브젝트 배치가 포함된 LocationData, 통합 오브젝트 HUD DTO, 상대 CSS 길이도 허용하는 progress ChatNode, 메시지/채널/HUD payload, Socket.io 양방향 이벤트 map의 단일 기준.
