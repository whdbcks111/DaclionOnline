...
- `HudContext.tsx`: PlayerStatus/Party/Location/Minimap HUD 설정, nullable 파티 snapshot을 포함한 서버 상태 payload, global/per-HUD 표시 옵션, quick slot의 localStorage persistence.
