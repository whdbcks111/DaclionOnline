...
- `SearchableSelect.tsx`, `SearchableSelect.module.scss`: label·코드·설명을 검색하고 PC popover/모바일 하단 목록으로 선택하는 공용 combobox다. 항목 행은 개수와 무관하게 최소 높이를 유지하고, 넓고 높은 목록 영역만 viewport 상한 안에서 스크롤한다.
