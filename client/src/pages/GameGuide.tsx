  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        commands: ['/사용 번호 (u)', '/장착 번호 (eq)', '/버리기 번호 [개수|전체] (q)', '/줍기 번호 [개수] 또는 전체 (p)'],
        tips: [
    ...
    articles: [
      {
        ...
        paragraphs: [
          '햄버거 메뉴의 HUD 설정에서 표시할 HUD와 세부 버튼을 선택합니다. 위치 편집 모드에서는 스킬 버튼을 각각 옮기고, 선택한 그리드 간격에 맞춰 정렬할 수 있습니다. 전투 퀵 버튼은 X/Y 좌표 단위와 화면 기준점을 따로 정할 수 있습니다.',
      ...
      },
      {
        id: 'chat',
        title: '채팅·채널·이미지',
        summary: '공개 채널, 개인 채널, 답장, 귓속말과 이미지 묶음 전송을 지원합니다.',
        tips: [
          '미디어 버튼 옆의 채팅 타입 메뉴에서 현재 채널, 같은 장소의 근처, 파티, 전체 광고를 선택할 수 있습니다. 공지는 관리자에게만 표시됩니다.',
          '입력창에 @닉네임 메시지를 쓰면 타입 버튼이 회색 귓속말로 바뀌고 상대에게만 전송됩니다.',
          '공개 메시지 옆의 답장 버튼을 누르면 입력창 위에서 원문을 확인할 수 있고, 전송된 답장의 원문 부분을 누르면 해당 메시지로 이동합니다.',
