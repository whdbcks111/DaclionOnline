...
const itemCases = [
    ...
    ['career:warrior', 'nebula_edge'],
    ['career:warrior', 'meteor_bulwark'],
    ['career:archer', 'gravity_arc_bow'],
    ['career:assassin', 'orbit_fang'],
    ['career:mage', 'starwell_staff'],
    ['career:warrior', 'chronoblade'],
    ['career:warrior', 'aeon_bulwark'],
    ['career:archer', 'pendulum_bow'],
    ['career:assassin', 'yesterglass_dagger'],
    ['career:mage', 'zero_hour_staff'],
    ['career:warrior', 'endstar_edge'],
    ['career:warrior', 'horizon_bulwark'],
    ['career:archer', 'constellation_bow'],
    ['career:assassin', 'entropy_fang'],
    ['career:mage', 'genesis_staff'],
