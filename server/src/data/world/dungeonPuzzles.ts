...
import { getLocation, registerConnectionCondition } from '../../models/world/Location.js';
import { registerResourceInteraction } from '../../models/actors/Resource.js';
import {
    activateTeleportArtifact,
    beginQuestionPuzzle,
    defineQuestionPuzzle,
    defineTeleportArtifact,
} from '../../models/world/DungeonPuzzle.js';
