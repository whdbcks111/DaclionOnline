...
export function buildAscendantLocations(): LocationData[] {
    return ASCENDANT_REGIONS.flatMap((region, index) => {
        ...
        const locations: LocationData[] = [
            ...
            {
                id: `${id}_echo_balcony`, name: `${region.name} 메아리 노대`,
            ...
            {
                id: `${id}_broken_span`, name: `${region.name} 끊긴 잔교`,
                x: x + 350, y: y + 330, z: z - 55, mapColor: region.mapColor,
                zoneType: 'hostile', tags: [...commonTags, GameTags.LOCATION_DUNGEON],
            ...
            {
                id: `${id}_north_fork`, name: `${region.name} 북측 갈림실`,
            ...
            {
                id: `${id}_north_archive`, name: `${region.name} 북측 잔향고`,
            ...
            {
                id: `${id}_north_loop`, name: `${region.name} 북측 회귀로`,
            ...
            {
                id: `${id}_south_fork`, name: `${region.name} 남측 갈림실`,
            ...
            {
                id: `${id}_south_archive`, name: `${region.name} 남측 잔향고`,
            ...
            {
                id: `${id}_south_loop`, name: `${region.name} 남측 회귀로`,
            ...
            {
                id: `${id}_hunter_cache`, name: `${region.name} 길잃은 자의 은닉고`,
            ...
            {
                id: `${id}_material_cache`, name: `${region.name} 침전물 은닉고`,
            ...
            {
                id: `${id}_spiral_upper`, name: `${region.name} 나선 상환`,
            ...
            {
                id: `${id}_spiral_lower`, name: `${region.name} 나선 하환`,
            ...
            {
                id: `${id}_spiral_nexus`, name: `${region.name} 나선 합류핵`,
            ...
            {
                id: `${id}_altar_antechamber`, name: `${region.name} 제단 전실`,
            ...
            {
                id: `${id}_final_fork`, name: `${region.name} 최심부 갈림목`,
            ...
            {
                id: `${id}_false_end`, name: `${region.name} 거짓 종착실`,
