...
import type { AttributeModifier } from '../../models/core/Attribute.js';
import {
    defineSkill,
...
} from '../../models/progression/Skill.js';
import type { SkillContext } from '../../models/progression/Skill.js';
...
import { THIRD_JOB_IDS } from '../progression/jobs.js';
import { calculateSmeltingExperience } from '../../modules/professions/forging.js';
import {
...
import { ALCHEMY_FEATURE_SKILL_ID } from '../../models/professions/Alchemy.js';
...
function defineAttributeBuff(id: string, label: string, description: string, modifiers: readonly BuffModifier[]): StatusEffectType {
    const apply = (target: import('../../models/core/Entity.js').default, level: number) => {
...
function applyStealth(target: import('../../models/core/Entity.js').default, id: string, level = 1): void {
    const source = `status:${id}`;
...
defineSkill({
    ...
    isVisible: ({ player }) => hasBlacksmithSkillAccess(player),
    canActivate: () => denySkill('/수리 <아이템 번호 또는 장착칸> 명령어를 사용하세요.'),
...
for (const skill of [
    ...
    {
        id: 'meteor_warden_gravity_hammer', name: '중력추 낙하', icon: 'affinities/stone', damageType: 'physical' as const,
        attribute: AttributeType.ATK, baseMultiplier: 3.35, perLevelMultiplier: 0.3,
        castTime: 1.3, cooldown: 9, propertyTag: GameTags.PROPERTY_STONE,
        statusEffectId: 'defense_reduction', statusDuration: 13, unavoidable: true, activationHeader: 'steel_slash',
    },
    {
        id: 'meteor_warden_starfall', name: '유성편 폭우', icon: 'affinities/light', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.22, perLevelMultiplier: 0.29,
        castTime: 1.55, cooldown: 10, propertyTag: GameTags.PROPERTY_LIGHT,
        statusEffectId: 'blindness', statusDuration: 6, activationHeader: 'sanctum_judgment',
    },
    {
        id: 'nebula_sovereign_event_horizon', name: '사건지평 봉쇄', icon: 'affinities/dark', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.58, perLevelMultiplier: 0.32,
        castTime: 1.45, cooldown: 10, propertyTag: GameTags.PROPERTY_DARK,
        statusEffectId: 'bind', statusDuration: 5.5, unavoidable: true, activationHeader: 'elemental_bind',
    },
    {
        id: 'nebula_sovereign_crownflare', name: '성운관 섬광', icon: 'affinities/light', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.45, perLevelMultiplier: 0.31,
        castTime: 1.7, cooldown: 10, propertyTag: GameTags.PROPERTY_LIGHT,
        statusEffectId: 'silence', statusDuration: 5.5, activationHeader: 'sanctum_judgment',
    },
    {
        id: 'frostclock_sentinel_zero_cut', name: '영시 절단', icon: 'affinities/ice', damageType: 'physical' as const,
        attribute: AttributeType.ATK, baseMultiplier: 3.72, perLevelMultiplier: 0.33,
        castTime: 1.05, cooldown: 8, propertyTag: GameTags.PROPERTY_ICE,
        statusEffectId: 'slowness', statusDuration: 8, unavoidable: true, activationHeader: 'steel_slash',
    },
    {
        id: 'frostclock_sentinel_pendulum', name: '진자뢰 반전', icon: 'affinities/electric', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.62, perLevelMultiplier: 0.32,
        castTime: 1.4, cooldown: 9, propertyTag: GameTags.PROPERTY_ELECTRIC,
        statusEffectId: 'paralytic_poison', statusDuration: 6, activationHeader: 'elemental_bind',
    },
    {
        id: 'zero_hour_queen_stillness', name: '멈춘 왕국', icon: 'affinities/ice', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.95, perLevelMultiplier: 0.35,
        castTime: 1.7, cooldown: 10, propertyTag: GameTags.PROPERTY_ICE,
        statusEffectId: 'frozen', statusDuration: 5, unavoidable: true, activationHeader: 'elemental_bind',
    },
    {
        id: 'zero_hour_queen_reversal', name: '어제의 형벌', icon: 'affinities/dark', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.82, perLevelMultiplier: 0.34,
        castTime: 1.35, cooldown: 9, propertyTag: GameTags.PROPERTY_DARK,
        statusEffectId: 'curse', statusDuration: 14, activationHeader: 'deathless_requiem',
    },
    {
        id: 'endstar_herald_nova', name: '종성 폭발', icon: 'affinities/fire', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 4.08, perLevelMultiplier: 0.36,
        castTime: 1.45, cooldown: 9, propertyTag: GameTags.PROPERTY_FIRE,
        statusEffectId: 'fire', statusDuration: 14, activationHeader: 'fireball',
    },
    {
        id: 'endstar_herald_silence', name: '침묵성가', icon: 'affinities/dark', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 3.98, perLevelMultiplier: 0.35,
        castTime: 1.65, cooldown: 10, propertyTag: GameTags.PROPERTY_DARK,
        statusEffectId: 'silence', statusDuration: 6, unavoidable: true, activationHeader: 'deathless_requiem',
    },
    {
        id: 'last_constellation_collapse', name: '성좌 붕괴', icon: 'affinities/dark', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 4.48, perLevelMultiplier: 0.4,
        castTime: 1.65, cooldown: 10, propertyTag: GameTags.PROPERTY_DARK,
        statusEffectId: 'overmaster', statusDuration: 5.5, unavoidable: true, activationHeader: 'deathless_requiem',
    },
    {
        id: 'last_constellation_genesis', name: '창세광', icon: 'affinities/holy', damageType: 'magic' as const,
        attribute: AttributeType.MAGIC_FORCE, baseMultiplier: 4.32, perLevelMultiplier: 0.38,
        castTime: 1.8, cooldown: 11, propertyTag: GameTags.PROPERTY_HOLY,
        statusEffectId: 'blindness', statusDuration: 7, unavoidable: true, activationHeader: 'sanctum_judgment',
    },
    {
        id: 'last_constellation_entropy', name: '소멸단죄', icon: 'affinities/metal', damageType: 'physical' as const,
        attribute: AttributeType.ATK, baseMultiplier: 4.22, perLevelMultiplier: 0.37,
        castTime: 1.1, cooldown: 9, propertyTag: GameTags.PROPERTY_METAL,
        statusEffectId: 'defense_reduction', statusDuration: 15, unavoidable: true, activationHeader: 'steel_slash',
    },
    {
