...
const firstJobs = [
    {
        ...
        skills: ['steel_slash', 'battle_rush', 'indomitable'],
    ...
    },
    {
        ...
        skills: ['arcane_arrow', 'multishot', 'stunning_shot', 'wind_evasion'],
    ...
    },
    {
        ...
        skills: ['stealth', 'ambush', 'venom_blade'],
    ...
    },
    {
        ...
        skills: ['magic_bolt', 'mana_barrier', 'elemental_bind', 'elemental_insight'],
