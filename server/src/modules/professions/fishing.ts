...
import {
    ...
    type FishData,
} from '../../models/professions/Fishing.js';
...
import { getPlayerByUserId } from '../player/player.js';
...
import { recordFishingCollectionCatch } from '../../models/professions/FishingCollection.js';
