            ...
            sendBotMessage(
                chat()
                    ...
                    .hide('보기', b => 
                        ...
                        .text(` ${player.exp}\n`)
                        .color('yellow', b => b.text('장착 정보'))
                        .text(` ${JSON.stringify(player.equipment.getAllEquipped())}\n`)
                        .color('yellow', b => b.text('인벤토리'))
                        .text(` ${JSON.stringify(player.inventory.items)}\n`)
                        .color('yellow', b => b.text('능력치'))
                        .text(` ${JSON.stringify(player.attribute.computed)}\n`)
                    )
                    .build()
            )
        },
