...
import { getAllLocationData, getAllLocations, normalizeLocationData, reloadAllLocations } from "../../models/world/Location.js";
import type { LocationData } from "../../models/world/Location.js";
...
import '../../data/world/locations.js'
import { initializeCodexData } from '../../data/world/codex.js';

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
const LOCATIONS_JSON = path.join(__dirname, '../../data/world/locations.json');
