...
| Forging | `ForgeForm.values/fromInput`, `ForgeMaterial.values/fromInput`, `createForgedItemSnapshot`, `renameForgedItem`, `enchantWeapon` | 형태·재료·리듬 정확도·난수 trait를 조합한 영속 장비 snapshot, 제작자 한정 이름 변경과 속성/signature 편향 마법 부여 |
