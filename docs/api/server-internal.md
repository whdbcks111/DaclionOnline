...
| Karma policy | `getPvpKarmaGain`, `getKarmaHeroReward`, `getKarmaDeathPenalty`; `Player.karma/isKarmaMarked/getKarmaSnapshot/addKarma/reduceKarma/setKarma/getKarmaAccessDeniedReason` | 지역별 PVP 악업, 현상 대상 보상, 고카르마 사망 규칙 계산과 Player dirty 변경 경계 |
