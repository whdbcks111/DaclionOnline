...
| `AttributeType`, `Attribute` | `values/fromKey`, `get`, `setBase`, `addModifier(s)`, `removeBySource` | 생명력/정신력 초당 재생을 포함한 클래스형 능력치 메타데이터와 기본값 + add/multiply 수정자 계산 |
