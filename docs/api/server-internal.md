...
| Threat | `ThreatAction.values/fromKey`, `MonsterAiDisposition.values/fromKey`, `normalizeMonsterAiProfile`, `ThreatTable.getContributionSnapshots/getDefeatContributionSnapshot`, `reportSupportThreat` | 마스터 AI 성향·지능·행동 가중치·도발 저항, 감쇠·이탈 제거되는 대상 선택용 위협도와 userId 기반 불변 처치 기여 원장의 분리 추적 |
