...
| Fishing | `startFishing`, `cancelFishing`, `isFishing` | 장소·낚싯대·미끼 검증, 입질 대기, 등급/미니게임/보상 연결 |
...
| Fishing | `FishRarity.values/fromKey`, `FishRarity.tag/sellPrice`, `define/get/getAllFish`, `getFishByRarity`, `rollFishRarity`, `rollFish`, `rollFishingExp` | 6등급 태그·매입가·가중치·행운 보정과 물고기 보상 registry |
