...
- `server/src/data/world/adaptiveMusic.test.ts`: 35개 고정 2마디 악구와 전조 정규화 훅 고유성, 632 장소 coverage·동일 권역 훅 보존·편곡 고유성, 32마디 A/A′/B/A″ 형식, 선율 진행·도약·파트별 음역·종지, 강박 chord-tone·화음 coverage·chord-linked bass, MIDI→Hz 경계, 실제 3/4, PPQ 192 tick engine, 전투 resolver, 음량 곡선·storage.
