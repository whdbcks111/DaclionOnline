...
- Lv.345부터 백야성소 대제단 너머 역근수해·태초심장에 진입한다. 24개 장소는 광휘뿌리/부패공동, 포자정원/기억호박 수로, 성수관/종자기록고와 광명/망각 천개로 갈라졌다 합쳐진다. Lv.360 역근 포식수는 낙하와 포자 숨결을 순서대로 사용하고, Lv.380 태초심장 아르보르는 치유·보호·제어 위협을 계산해 세 기술을 무작위로 사용한다. 심장씨앗 셋이 하나라도 남으면 아르보르가 받는 피해가 70% 줄어들며, 첫 기억의 제단을 풀면 hidden 기억호박 유물고 우회로가 열린다.
...
- Lv.420부터 성운제의 왕좌 너머 동결시계원에 진입한다. 14개 장소는 얼어붙은 분침/진자 빙하와 모래시계 묘역/뒤집힌 설원, 어제 회랑/내일 금고로 갈라졌다 합쳐진다. Lv.440 빙시계 파수장은 영시 절단과 진자뢰를 순서대로 사용하고, Lv.460 영시여왕 크로니아는 정지와 역행을 무작위로 사용한다.
- Lv.460부터 영시여왕의 왕좌 너머 종언성단에 진입한다. 15개 장소는 재별무리/부서진 성좌와 침묵태양/맹세혜성, 창세/소멸 항로로 갈라졌다 최후지평에서 합쳐진다. Lv.480 종성의 전령 에녹은 신성과 침묵을 번갈아 사용하고, Lv.500 최후성좌 라스트라는 붕괴·창세·소멸을 무작위로 선고한다.
...
현재 월드는 총 276개 장소이며 다음 성장 동선을 제공한다. 성장 관문 보스는 Lv.15부터 최대 30레벨 간격으로 등장하고, 같은 레벨 일반 몬스터보다 최소 5배 경험치와 훨씬 높은 생명력을 가진다. 모든 보스가 미니게임을 강제하지 않으며 일부는 복수 SkillData 무작위 패턴·상태이상·주변 오브젝트 기믹으로 차별화한다.
