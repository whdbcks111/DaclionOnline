...
루미나르 개척촌 광장의 의뢰관리인 세나는 한국 표준시 자정마다 다시 열리는 성장 일일 의뢰를 제공한다. Lv.1~49/50~149/150~299/300~499/500+ 다섯 성장 구간에 토벌·채광·낚시와 Lv.70부터의 채집을 조합한 19개 정의를 사용한다. 날짜와 userId로 오늘의 유형을 결정하므로 같은 계정은 하루 동안 같은 의뢰를 보지만 서버 전체에는 여러 생활 콘텐츠가 고르게 배정된다. Lv.70 미만은 아직 접근하기 어려운 채집 의뢰를 받지 않는다.
