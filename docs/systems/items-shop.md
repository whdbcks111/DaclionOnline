...
현재 `general_store`가 포션, 여행자 빵, 맑은 샘물, 낡은 검, 낡은 방패, 독 단검, 가벼운 활·화살, 견습 마법 지팡이를 판매·매입하며 루미나르 장터의 `shop_general`(별등불 잡화점)에 연결되어 있다. `fishing_store`는 초보자·정교한 낚싯대와 지렁이 미끼를 판매하고 낚시 도구·미끼·등급별 물고기를 매입하며 루미나르 물빛 연못에 연결된다.
